        ...
        <div className="flex flex-col sm:flex-row items-center justify-between gap-4 pb-6" style={{ borderBottom: "1px solid rgba(255,255,255,0.05)" }}>
          <div className="flex items-center gap-2.5">
            ...
            <div>
              ...
              <p style={{ color: "rgba(255,255,255,0.2)", fontSize: "0.7rem" }}>Growth Through Performance</p>
            </div>
          </div>
          ...
          <div className="flex items-center gap-4">
            <div className="flex items-center gap-1">
              ...
              <span style={{ color: "rgba(255,255,255,0.3)", fontSize: "0.72rem", marginLeft: "4px", fontWeight: 600 }}>5.0 Google</span>
            </div>
            <span style={{ color: "rgba(255,255,255,0.1)" }}>|</span>
            <span style={{ color: "rgba(255,255,255,0.3)", fontSize: "0.72rem", fontWeight: 600 }}>50+ Brands Scaled</span>
          </div>
        </div>
